...
function displayUnCheck(){
    ...
    // const checkboxes = document.querySelectorAll('input[name="taskList"]:checked'); // Select only checked checkboxes
    // checkboxes.forEach(checkbox => {
    //     notesObj1.push(checkbox.value);
    // });
    // checkboxes.forEach((checkbox,ele,index,label) => {
    //     if(checkbox.checked ==false){
    //         // notesObj1.push(label.innerHTML);
    //         // notesObj1.remove(index);
...
//    notesObj.forEach(function(index,checked){
//     if(checked==false){
